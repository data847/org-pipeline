...
Usage:
    ...
    python run_org_pipeline.py --github-repo lh2-tech/mediaos-fastapi --tokens-file tokens --workers 1
    python run_org_pipeline.py --github-repo lh2-tech/repo-a --github-repo lh2-tech/repo-b --tokens-file tokens --workers 4
...
EVAL_KIT = CODING / "lh2-datalabs-eval-kit"
...
def parse_args() -> argparse.Namespace:
    ...
    target.add_argument(
        ...
        help=(
            ...
            "Example: --github-repo lh2-tech/mediaos-fastapi --github-repo lh2-tech/backend"
        ),
    )
    ...
    target.add_argument(
        ...
        help=(
            ...
            "Example: --gitlab-project GOMOW/gomow_nodejs --gitlab-project GOMOW/gomow-crew_android"
        ),
    )
    target.add_argument(
        "--local-repos-dir",
